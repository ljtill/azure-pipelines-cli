...
impl Component for Help {
    fn draw(&self, f: &mut Frame, area: Rect) -> Result<()> {
        ...
        let help_text = vec![
            ...
            Line::from("  ← / q / Esc    Go back / collapse tree rows"),
            ...
            Line::from(""),
            Line::from("  1 / 2 / 3 / 4  Switch area: Dashboard / Boards / Repos / Pipelines"),
            Line::from("  [/]            Switch views within the current area"),
